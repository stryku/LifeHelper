...
{
    using LocalQtInstance = P2::Instance<P2::Controller::Controller, P2::View::QtView<P2::Input::InputPropagator>, P2::Input::InputPropagator, P2::Model::Model, P2::ProgramInternals, QWidget>;
